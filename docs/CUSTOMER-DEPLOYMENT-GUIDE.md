...
```bash
# Create Kind cluster
kind create cluster --name tavana-local

# Pull and load images
docker pull angelerator/tavana-gateway:v1.0.0
docker pull angelerator/tavana-worker:v1.0.0
kind load docker-image angelerator/tavana-gateway:v1.0.0 --name tavana-local
kind load docker-image angelerator/tavana-worker:v1.0.0 --name tavana-local
